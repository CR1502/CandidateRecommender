    ...
    def rank_candidates(
        ...
        try:
            ...
            for i, (resume, score) in enumerate(zip(resumes, similarities)):
                ...
                # Classify candidate based on score
                if percentage >= 90:
                    category = "Perfect Match"
                    category_emoji = "🌟"
                    category_color = "#00D26A"  # Green
                elif percentage >= 70:
                    category = "Ideal Candidate"
                    category_emoji = "⭐"
                    category_color = "#4CAF50"  # Light green
                elif percentage >= 50:
                    category = "Good Candidate"
                    category_emoji = "✅"
                    category_color = "#FFA726"  # Orange
                elif percentage >= 20:
                    category = "Okay Candidate"
                    category_emoji = "👍"
                    category_color = "#FF9800"  # Dark orange
                else:
